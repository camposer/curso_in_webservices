...
public interface IPersonaRest {
	...
	@GET
	@Path("/{id}")
	public PersonaTo obtenerPersona(@PathParam("id") Integer id);
	...
	@GET
	@Path("/order/nombre")
	public List<PersonaTo> obtenerPersonasOrdenadasPorNombre();
	...
	@PUT
	@Path("/{id}")
	public void modificarPersona(@PathParam("id") Integer id, PersonaTo pTo);
